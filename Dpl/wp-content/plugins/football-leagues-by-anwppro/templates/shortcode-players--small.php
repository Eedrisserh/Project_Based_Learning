...
<div class="anwp-b-wrap">
	<div class="table-responsive">
		<table class="table table-sm table-bordered player-list player-list--<?php echo esc_attr( $data->type ); ?> context--<?php echo esc_attr( $data->context ); ?>">

			<tbody>
			<tr class="anwp-bg-light small">
			...
			foreach ( $players as $index => $p ) :
				...
				<tr class="anwp-text-center">
					...
					<?php if ( ! $compact_layout ) : ?>
						...
						<td class="player-list__nationality d-none d-lg-table-cell">
							<?php if ( ! empty( $player->nationality ) && is_array( $player->nationality ) ) : ?>
								<?php foreach ( $player->nationality as $country_code ) : ?>
